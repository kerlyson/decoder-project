...
@Repository
public interface NotificationJpaRespository extends JpaRepository<NotificationEntity, UUID> {

    public Page<NotificationEntity> findAllByUserIdAndNotificationStatus(
            UUID userId,
