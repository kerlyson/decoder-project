...
public class NotificationPersistencePortImpl implements NotificationPersistencePort {
    ...
    final NotificationJpaRespository notificationJpaRespository;
    final ModelMapper modelMapper;

    public NotificationPersistencePortImpl(
            NotificationJpaRespository notificationJpaRespository,
            ModelMapper modelMapper
    ) {
        this.notificationJpaRespository = notificationJpaRespository;
    ...
    public NotificationDomain save(NotificationDomain notificationDomain) {
        NotificationEntity notificationEntity = notificationJpaRespository.save(
    ...
    public List<NotificationDomain> findAllByUserIdAndNotificationStatus(UUID userId, NotificationStatus notificationStatus, PageInfo pageInfo) {
        ...
        return notificationJpaRespository.findAllByUserIdAndNotificationStatus(
                userId,
                notificationStatus,
                pageable
        ).stream().map(entity -> {
    ...
    public Optional<NotificationDomain> findByNotificationIdAndUserId(UUID notificationId, UUID userId) {
        Optional<NotificationEntity> notificationEntityOptional = notificationJpaRespository
